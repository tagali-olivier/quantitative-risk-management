...
Le niveau de quantile associé à la VaR est :
...
Comme ce quantile correspond généralement à une perte, il est négatif. La Value at Risk est donc exprimée comme une perte positive :
