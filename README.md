...
Dans la suite de cette section, nous utiliserons principalement les rendements logarithmiques:
...
$$\mathrm{VaR}_{t+1}(c)=V_t \left[ -\mu_{t+1} + z_c \sigma_{t+1} \right]$$
...
Pour chaque scénario $s$, on obtient un profit ou une perte :
...
$$\mathbf{r}_t
=
\begin{pmatrix}r_{\mathrm{AAPL},t}\\
r_{\mathrm{MSFT},t}\\
r_{\mathrm{NVDA},t}\\
r_{\mathrm{AMZN},t}
\end{pmatrix}$$
